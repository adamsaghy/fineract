...
public class WorkingCapitalLoanAccountStepDef extends AbstractStepDef {
    ...
    @Then("Modify a working capital loan with breachId {long} will result with an error")
    public void modifyLoanWithInvalidBreachId(final long breachId) {
        final PutWorkingCapitalLoansLoanIdRequest modifyRequest = workingCapitalLoanRequestFactory.defaultModifyWorkingCapitalLoansRequest() //
                .breachId(breachId); //
        String message = ErrorMessageHelper.breachIdNotFoundFailure(breachId);
        verifyModifyWorkingCapitalLoanAccountFailure(modifyRequest, 403, message);
    }
    ...
    public void modifyLoanWithInvalidNearBreachId(final long nearBreachId) {
        ...
        final PutWorkingCapitalLoansLoanIdRequest modifyRequest = workingCapitalLoanRequestFactory.defaultModifyWorkingCapitalLoansRequest() //
                .breachId(breachId) //
                .nearBreachId(nearBreachId); //
        String message = ErrorMessageHelper.nearBreachIdNotFoundFailure(nearBreachId);
        verifyModifyWorkingCapitalLoanAccountFailure(modifyRequest, 403, message);
    }
    ...
    public void checkCreateWCLoanAccountNoneBreachNearBreachData() {
        checkCreateWCLoanAccountBreachNearBreachData(null, null);
    }
