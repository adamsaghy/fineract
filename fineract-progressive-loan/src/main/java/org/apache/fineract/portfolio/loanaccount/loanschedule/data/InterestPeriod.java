...
public class InterestPeriod implements Comparable<InterestPeriod> {
    ...
    public String toString() {
        return "InterestPeriod{" + "fromDate=" + fromDate + ", dueDate=" + dueDate + ", rateFactor=" + rateFactor + ", disbursementAmount="
                + disbursementAmount + ", balanceCorrectionAmount=" + balanceCorrectionAmount + ", outstandingLoanBalance="
                + outstandingLoanBalance + ", getCalculatedDueInterest=" + getCalculatedDueInterest() + '}';
    }
}
