...
public class HookHelper {
    ...
    public Integer updateHook(final String payloadURL, final Long hookId) {
        ...
        return Utils.performServerPut(requestSpec, responseSpec, UPDATE_HOOK_URL, getTestHookAsJson(payloadURL), "resourceId");
    }
    ...
    public Integer deleteHook(final Long hookId) {
        ...
        return Utils.performServerDelete(requestSpec, responseSpec, DELETE_HOOK_URL, "resourceId");
    }
    ...
    public void verifyHookCreatedOnServer(final Long hookId) {
        ...
        final Integer responseHookId = Utils.performServerGet(requestSpec, responseSpec, GET_URL, "id");
    ...
    public void verifyUpdateHook(final String updateURL, final Long hookId) {
        ...
        final String GET_URL = "/fineract-provider/api/v1/hooks/" + hookId + "?" + Utils.TENANT_IDENTIFIER;
        ArrayList<HashMap<String, String>> map = Utils.<ArrayList<HashMap<String, String>>>performServerGet(requestSpec, responseSpec,
                GET_URL, "config");
    ...
    public void verifyDeleteHook(final Long hookId) {
        ...
        ArrayList<HashMap<String, String>> array = Utils.<ArrayList<HashMap<String, String>>>performServerGet(requestSpec, responseSpec404,
                GET_URL, "errors");
