...
public class CampaignsTest {
    ...
    public void setup() {
        ...
        this.campaignsHelper = new CampaignsHelper(requestSpec, responseSpec);
    }
    ...
    public void testSupportedActionsForCampaignWithTriggerTypeAsDirect() {
        ...
        this.campaignsHelper.verifyCampaignCreatedOnServer(requestSpec, responseSpec, campaignId);
        ...
        // activating campaign
        Integer activatedCampaignId = this.campaignsHelper.performActionsOnCampaign(requestSpec, responseSpec, campaignId,
                ACTIVATE_COMMAND);
    ...
    public void testSupportedActionsForCampaignWithError() {
        ...
        CampaignsHelper campaignsHelperWithError = new CampaignsHelper(requestSpec, responseSpecWithError);
        // creating new campaign
        Integer campaignId = this.campaignsHelper.createCampaign(NON_TRIGGERED_REPORT_NAME, DIRECT_TRIGGER_TYPE);
        this.campaignsHelper.verifyCampaignCreatedOnServer(requestSpec, responseSpec, campaignId);
        ...
        ArrayList<HashMap<String, Object>> campaignDateValidationData = (ArrayList<HashMap<String, Object>>) campaignsHelperWithError
                .performActionsOnCampaignWithFailure(campaignId, ACTIVATE_COMMAND,
                        Utils.getLocalDateOfTenant().plusDays(1).format(DateTimeFormatter.ofPattern(CommonConstants.DATE_FORMAT)),
        ...
        ArrayList<HashMap<String, Object>> campaignErrorData = (ArrayList<HashMap<String, Object>>) campaignsHelperWithError
                .performActionsOnCampaignWithFailure(activatedCampaignId, ACTIVATE_COMMAND,
                        Utils.getLocalDateOfTenant().format(DateTimeFormatter.ofPattern(CommonConstants.DATE_FORMAT)),
                        CommonConstants.RESPONSE_ERROR);
