...
public class GuarantorHelper {
    ...
    public HashMap updateGuarantor(final Integer guarantorId, final Integer loanId, final String guarantorJSON) {
        return Utils.performServerPut(requestSpec, responseSpec, LOAN_URL + loanId + GUARANTOR_API_URL + guarantorId + TENANT,
    ...
    public HashMap deleteGuarantor(final Integer guarantorId, final Integer loanId) {
        return Utils.performServerDelete(requestSpec, responseSpec, LOAN_URL + loanId + GUARANTOR_API_URL + guarantorId + TENANT, "");
    }

    public Object getGuarantor(final Integer guarantorId, final Integer loanId, final String jsonToGetBack) {
        return Utils.performServerGet(requestSpec, responseSpec, LOAN_URL + loanId + GUARANTOR_API_URL + guarantorId + TENANT,
                jsonToGetBack);
    }

    public List getAllGuarantor(final Integer loanId) {
        return Utils.performServerGet(requestSpec, responseSpec, LOAN_URL + loanId + GUARANTOR_API_URL + TENANT, "");
    }
